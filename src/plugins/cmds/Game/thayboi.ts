...
const thayboiCommand: Command = {
  name: "thayboi",
  alias: ["thayboi"],
  version: "0.0.1",
  role: 0,
  desc: "Bói tình yêu, sự ngiệp, cuộc đời",
  guide: "{pn}: Bói tình yêu, sự ngiệp, cuộc đời",
  cd: 5,
  prefix: true,
  ...
  onCall: async function (ctx: CommandOnCallContext): Promise<void> {
    ...
    await reply({ body: data[randomIndex] });
  },
};

export default thayboiCommand;
